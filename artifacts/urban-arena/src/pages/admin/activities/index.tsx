...
export default function AdminActivities() {
  ...
  const handleSyncAll = async () => {
    ...
    for (let i = 0; i < sorted.length; i++) {
      ...
      try {
        // Always run setup so the folder hierarchy stays in sync with the
        // current location + address (idempotent — reuses existing folders).
        ...
        // Sync files from Drive into GCS / activity media fields
